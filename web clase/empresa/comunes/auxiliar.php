        ...
        <?php if (isset($par[$k]['def'])) : ?>
            <div class="form-group">
                ...
                <?php elseif ($par[$k]['tipo'] === TIPO_PASSWORD) : ?>
                    <input type="password" class="form-control <?= valido($k, $errores) ?>" id="<?= $k ?>" name="<?= $k ?>" value="">
                <?php elseif ($index || !isset($par[$k]['virtual'])) : ?>
                    <input type="text" class="form-control <?= valido($k, $errores) ?>" id="<?= $k ?>" name="<?= $k ?>" value="<?= h($args[$k]) ?>">
                <?php endif ?>
